...
class OneThemeData with Diagnosticable {
  ...
  factory OneThemeData.fromContext(BuildContext context) {
    ...
    theme.textFieldLabelHorizFocused = theme.textFieldLabelHoriz.copyWith(color: OneColors.brandAneed);
    ...
    theme.textFieldLabelFocused = theme.textFieldLabel.copyWith(color: OneColors.brandAneed);
