 ...
 * File Created: Friday, 7th May 2021 9:16:56 am
 * Author: https://github.com/boringdeveloper/FlutterSwitch
 * -----
 * Last Modified: Friday, 7th May 2021 9:17:08 am
...
class _FlutterSwitchState extends State<FlutterSwitch> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    LinearGradient? _switchActiveGradient;
    ...
    if (widget.value) {
      ...
      _switchActiveGradient = widget.activeGradient;
            ...
            child: Opacity(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: _switchColor,
                  border: _switchBorder,
                  gradient: _switchActiveGradient,
                ),
                child: Stack(
                  children: <Widget>[
                    AnimatedOpacity(
