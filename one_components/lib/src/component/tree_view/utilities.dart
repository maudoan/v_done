  ...
  static Color getColor(String value) {
    ...
    if (_hexExp.hasMatch(colorValue)) {
      ...
      if (colorValue.length == 3 || colorValue.length == 4) {
        ...
        final List<String> pieces = colorValue.split('').map((String piece) => '$piece$piece').toList();
      ...
      final parts = _rgbExp.allMatches(value);
      int r = 0;
      int g = 0;
      int b = 0;
      ...
      final parts = _rgbaExp.allMatches(value);
      int r = 0;
      int g = 0;
      int b = 0;
      double a = 1;
