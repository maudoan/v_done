...
class TreeViewTheme {
  ...
  Duration get quickExpandSpeed => Duration(milliseconds: (expandSpeed.inMilliseconds * 1.6).toInt());

  @override
  int get hashCode {
    return Object.hash(colorScheme, levelPadding, iconPadding, iconTheme, expanderTheme, labelStyle, dense, verticalSpacing, horizontalSpacing, parentLabelStyle, labelOverflow, parentLabelOverflow);
  }
